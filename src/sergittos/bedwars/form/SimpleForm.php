...
class SimpleForm extends EasyUISimpleForm {
    ...
    protected function addRedirectFormButton(string $name, Form $form): void {
    ...
    protected function addGoBackButton(Form $form): void {
        $this->addRedirectFormButton("Go back", $form);
    }
